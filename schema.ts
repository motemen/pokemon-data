...
export const PokemonDataItem = z
  .object({
    ...
    showdown_form_order: z.nullable(z.number()),
    showdown_name: z.nullable(z.string()),
    showdown_id_name: z.nullable(z.string()),
    showdown_base_species: z.nullable(z.string()),
    showdown_forme: z.nullable(z.string()),
